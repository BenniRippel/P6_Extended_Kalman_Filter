...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    ...
    ekf_.P_ << measurement_pack.raw_measurements_[4],
               measurement_pack.raw_measurements_[5],
               measurement_pack.raw_measurements_[6],
               measurement_pack.raw_measurements_[7];
      ...
      */
      ...
      ekf_.P_ << measurement_pack.raw_measurements_[3],
                measurement_pack.raw_measurements_[4],
                measurement_pack.raw_measurements_[5],
                measurement_pack.raw_measurements_[6];
